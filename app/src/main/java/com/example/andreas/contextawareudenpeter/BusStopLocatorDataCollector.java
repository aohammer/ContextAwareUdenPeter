...
public class BusStopLocatorDataCollector implements SensorEventListener {
    ...
    public BusStopLocatorDataCollector(Context context, LocationProvider locationProvider) {
        //sensor setup
